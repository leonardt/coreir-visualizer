...
```
git clone -b 448-freeze https://github.com/rdaly525/coreir.git
cd coreir
...
pip install git+git://github.com/leonardt/pycoreir.git@448-freeze  # Need the dev branch of pycoreir
```
